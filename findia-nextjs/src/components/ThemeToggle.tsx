  ...
  try {
    ...
    return (
      <div className="relative">
        ...
        {/* Tooltip indicator */}
        <motion.div
          className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black dark:bg-white text-white dark:text-black text-xs px-2 py-1 rounded opacity-0 pointer-events-none"
    ...
    return (
      <div className="flex bg-gray-100 rounded-xl p-1">
        <button 
          ...
          className="p-2 rounded-lg bg-white shadow-sm cursor-pointer"
        >
          🌙
        </button>
      </div>
