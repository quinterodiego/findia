      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <button
            ...
            className="
              w-full px-4 py-3 bg-blue-600 text-white rounded-md font-medium cursor-pointer
          ...
          <button
            ...
            className="
              w-full px-4 py-2 bg-gray-100 text-gray-700 rounded-md cursor-pointer
          ...
          {connectionStatus && (
            <button
              ...
              className="
                w-full px-4 py-2 bg-green-100 text-green-700 rounded-md cursor-pointer
            ...
            {result.instructions && result.instructions.length > 0 && (
              <div className="mt-3 p-3 bg-white border border-green-200 rounded text-xs">
                ...
                {connectionStatus && (
                  <button
                    onClick={openGoogleSheet}
                    className="mt-3 px-3 py-1 bg-green-600 text-white rounded text-xs hover:bg-green-700 transition-colors flex items-center gap-1 cursor-pointer"
                  >
